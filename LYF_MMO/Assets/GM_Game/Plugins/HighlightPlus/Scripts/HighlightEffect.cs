    ...
    public partial class HighlightEffect : MonoBehaviour {
        ...
        void ComposeSmoothBlend(Visibility smoothGlowVisibility, Visibility smoothOutlineVisibility) {
            ...
            if (renderSmoothGlow) {
                ...
                matComposeGlow.SetVector(ShaderParams.Flip, flipY ? new Vector3(1, -1, 0) : new Vector3(0, 1, 0));
                if (glowOptimalBlit) {
            ...
            if (renderSmoothOutline) {
                ...
                matComposeOutline.SetVector(ShaderParams.Flip, (flipY) ? new Vector3(1, -1, 0) : new Vector3(0, 1, 0));
